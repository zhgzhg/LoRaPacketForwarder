...
CFLAGS = -std=c++14 -Wall -DLINUX -DARDUINO=999 -IRadioLib/src/ -IRadioLib/src/modules/ -IRadioLib/src/protocols/ \
	 -IRadioLib/src/modules/RF69/ -IRadioLib/src/modules/RFM9x/ -IRadioLib/src/modules/SX127x/ \
         -IRadioLib/src/modules/SX126x/ -IRadioLib/src/modules/SX128x/ -IRadioLib/src/linux-workarounds/ \
	 -IRadioLib/src/linux-workarounds/SPI/
...
SRC = $(wildcard RadioLib/src/linux-workarounds/SPI/*.cpp) $(wildcard RadioLib/src/linux-workarounds/*.cpp) \
      ...
      $(wildcard RadioLib/src/modules/SX128x/*.cpp) $(wildcard RadioLib/src/modules/SX126x/*.cpp) \
      $(wildcard RadioLib/src/*.cpp) $(wildcard smtUdpPacketForwarder/base64/*.c) \
      $(wildcard smtUdpPacketForwarder/gpsTimestampUtils/*.cpp) $(wildcard smtUdpPacketForwarder/*.cpp) \
      $(wildcard *.cpp)
